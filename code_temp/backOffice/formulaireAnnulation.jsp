...
<body>
    ...
    <div class="main-container">
        ...
        <main class="content">
            <h2>Definir une regle d'annulation de reservation</h2>
            ...
            <form action="/ticketing/annulation/insert" method="post">
                ...
                <select name="regleAnnulationReservation.idVol" id="vol" required>
                ...
                <label for="nbHeureLimiteAvantVol">Nombre d'heures limite avant vol :</label>
                <input type="number" name="regleAnnulationReservation.nbHeureLimiteAvantVol" id="nbHeureLimiteAvantVol" required>
